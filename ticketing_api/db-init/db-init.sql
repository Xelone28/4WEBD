...
-- Créer l'utilisateur lou-anne
INSERT INTO public.users
(email, hashed_password, first_name, last_name, is_admin) -- Inclure is_admin dans l'INSERT
VALUES('lougautr@gmail.com', 'password', 'Lou-Anne', 'Gautherie', TRUE);
...
-- Vérifier que la colonne is_admin a bien été ajoutée
-- (Cette commande est spécifique à psql et peut être utilisée pour vérifier la structure de la table)
-- \d+ public.users

-- Vérifier que l'utilisateur lou-anne est bien administrateur
SELECT id, email, is_admin
FROM public.users
WHERE email = 'lougautr@gmail.com';